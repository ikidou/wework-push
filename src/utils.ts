...
export function checkWxPushSign(
  ...
  console.log("[checkWxPushSign] searchParams=", params);
  ...
  console.log("[checkWxPushSign] timestamp=", timestamp);
  console.log("[checkWxPushSign] nonce=", nonce);

  console.log("[checkWxPushSign] tmp_token=", tmp_token);
  console.log("[checkWxPushSign] signature=", signature);
  console.log("[checkWxPushSign] calc_signature=", calc_signature);
...
export function requireEnv(key: string): string {
  ...
  throw Error(`Env '${key}' NOT SET OR IS EMPTY`);
}
